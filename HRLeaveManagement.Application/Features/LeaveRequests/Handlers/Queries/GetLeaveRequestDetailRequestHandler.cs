...
{
    public class GetLeaveRequestDetailRequestHandler : IRequestHandler<GetLeaveReaquestDetailRequest, LeaveRequestDto>
    {
        ...
        public async Task<LeaveRequestDto> Handle(GetLeaveReaquestDetailRequest request, CancellationToken cancellationToken)
        {
